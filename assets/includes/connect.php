...
// Or a slightly more verbose, but perhaps clearer, approach
if (array_key_exists('HTTP_ACCEPT_LANGUAGE', $_SERVER)) {
  $acceptLanguage = $_SERVER['HTTP_ACCEPT_LANGUAGE'];
} else {
  $acceptLanguage = 'en-US'; // Or a default value like 'en-US'
}

$langs = prefered_language($available_languages, $acceptLanguage);
$lang = key($langs);
